...
angular
  ...
  .config(($stateProvider) => {
    $stateProvider
      ...
      .state("admin.maintenance-users", {
        url: "/maintenance/:maintenanceId/users/:maintenanceName",
        views: {
          "extendTop@": {
            templateUrl: "templates/maintenance-users-extend-top.html",
            controller: "MaintenanceController",
            controllerAs: "MaintenanceCtrl",
          },
          "main@": {
            templateUrl: require("./templates/maintenance-users.html"),
            controller: "MaintenanceController",
            controllerAs: "MaintenanceCtrl",
          },
          "extendBottom@": {
            templateUrl: "templates/maintenance-users-extend-bottom.html",
            controller: "MaintenanceController",
            controllerAs: "MaintenanceCtrl",
          },
        },
  ...
  .run(($templateCache, $http) => {
    ...
    $templateCache.put("templates/maintenance-users-extend-bottom.html", "");
    $templateCache.put("templates/maintenance-users-extend-top.html", "");

    $http
      .get(`templates/maintenance-users.html`)
      .then((response) => {
        $templateCache.put("templates/maintenance-users.html", response.data);
      })
