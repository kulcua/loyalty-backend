export default class LevelController {
    ...
    self.tableParams = new self.NgTableParams(
      ...
      },
      {
        getData: function (params) {
          ...
          self.LevelService.getLevels(self.ParamsMap.params(params.url())).then(
            (res) => {
      ...
      self.tableCustomerParams = new self.NgTableParams(
        {},
        {
          getData: function (params) {
            ...
            self.LevelService.getLevelCustomers(
  ...
  getLevelData() {
    ...
    if (self.levelId) {
      self.LevelService.getLevel(self.levelId).then(
        (res) => {
  ...
  getLevelCsvData(levelId, levelName) {
    let self = this;
    if (levelId) {
      self.LevelService.getFile(levelId).then(function (res) {
        let date = new Date();
        let filename =
          levelName.replace(" ", "-") +
          "-" +
  ...
  addLevel(newLevel) {
    ...
    self.LevelService.postLevel(newLevel).then(
      (res) => {
  ...
  editLevel(editedLevel) {
    ...
    self.LevelService.putLevel(editedLevel).then(
      (res) => {
        if (self.$scope.levelImage) {
          self.$scope.fileValidate = {};
  ...
  setLevelState(state, levelId) {
    ...
    self.LevelService.postActivateLevel(state, levelId).then(
      () => {
        let message = self.$filter("translate")(
