export default class RequestController {
    ...
    self.tableParams = new self.NgTableParams(
      ...
      },
      {
        getData: function (params) {
          ...
          self.loaderStates.requestList = true;
          self.RequestService.getLevels(self.ParamsMap.params(params.url())).then(
            (res) => {
              self.$scope.levels = res;
              params.total(res.total);
              self.loaderStates.requestList = false;
  ...
  //           self.RequestService.getLevelCustomers(
  ...
  //   if (self.levelId) {
  //     self.RequestService.getLevel(self.levelId).then(
  //       (res) => {
  ...
  //     self.RequestService.getLevelImage(self.levelId)
  //       .then((res) => {
  ...
  //   let self = this;
  //   if (levelId) {
  //     self.RequestService.getFile(levelId).then(function (res) {
  //       let date = new Date();
  //       let filename =
  //         levelName.replace(" ", "-") +
  //         "-" +
  ...
  //   self.RequestService.postLevel(newLevel).then(
  //     (res) => {
  //       if (self.$scope.levelImage) {
  //         self.$scope.fileValidate = {};

  //         self.RequestService.postLevelImage(res.id, self.$scope.levelImage)
  //           .then((res2) => {
  ...
  //               err.data
  //             );
  //             self.RequestService.storedFileError = self.$scope.fileValidate;
  ...
  //   self.RequestService.putLevel(editedLevel).then(
  //     (res) => {
  //       if (self.$scope.levelImage) {
  //         self.$scope.fileValidate = {};

  //         self.RequestService.postLevelImage(self.levelId, self.$scope.levelImage)
  //           .then((res2) => {
  //             self.$state.go("admin.levels-list", { levelId: self.levelId });
  //             let message = self.$filter("translate")(
  ...
  //   self.RequestService.postActivateLevel(state, levelId).then(
  //     () => {
  //       let message = self.$filter("translate")(
  ...
  //   this.RequestService.deleteLevelImage(this.levelId)
  //     .then((res) => {
  //       self.$scope.levelImagePath = false;
  //       let message = self.$filter("translate")(
